import type { WarehousingRequest } from './index'
...
export const mockWarehousingRequests: WarehousingRequest[] = [
  {
    ...
    cargo: {
      ...
      weight: 1000,
      dimensions: { length: 200, width: 150, height: 100, unit: 'cm' as any },
      value: 45000,
      currency: 'EUR',
  ...
  },
  {
    ...
    handlingServices: ['LOADING', 'UNLOADING'],
    valueAddedServices: ['LABELING'],
    securityLevel: 'STANDARD' as any,
    requiresTemperatureControl: false,
    requiresHumidityControl: false,
    requiresSpecialHandling: false,
