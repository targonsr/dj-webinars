...
const navigation = computed(() => [
  ...
  { name: 'All Requests', href: '/dashboard/requests', icon: InboxIcon, current: route.path === '/dashboard/requests' },
  { name: 'Transportation', href: '/dashboard/transportation', icon: TruckIcon, current: route.path.startsWith('/dashboard/transportation') },
  { name: 'Warehousing', href: '/dashboard/warehousing', icon: BuildingStorefrontIcon, current: route.path.startsWith('/dashboard/warehousing') },
  ...
  { name: 'Billing', href: '/dashboard/billing', icon: CreditCardIcon, current: route.path.startsWith('/dashboard/billing') },
  { name: 'Reports', href: '/dashboard/reports', icon: ChartBarIcon, current: route.path.startsWith('/dashboard/reports') },
