    ...
    <div class="card overflow-hidden">
            ...
            @for (reservation of reservations(); track reservation.id) {
              <tr class="hover:bg-gray-50 dark:hover:bg-dark-700">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <a [routerLink]="['/customers', reservation.customerId]"
                     class="text-sm font-medium text-primary-600 hover:text-primary-500">
                    {{ reservation.customerName }}
                  </a>
                  <div class="text-sm text-gray-500 dark:text-gray-400">ID: {{ reservation.customerId }}</div>
                </td>
                <td class="px-6 py-4">
      ...
      @if (reservations().length === 0) {
        <div class="text-center py-12">
          ...
          <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">No reservations found</h3>
