            ...
            @for (request of requests(); track request.id) {
              <tr class="hover:bg-gray-50 dark:hover:bg-dark-700">
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  <div class="text-sm font-medium text-gray-900 dark:text-white">{{ request.customerName }}</div>
                  <div class="text-sm text-gray-500 dark:text-gray-400">ID: {{ request.customerId }}</div>
                </td>
                <td class="px-6 py-4">
