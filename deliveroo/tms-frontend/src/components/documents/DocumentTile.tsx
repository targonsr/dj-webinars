...
import { FileText, Eye, Edit, Building, User, Truck, X, Download, ExternalLink } from 'lucide-react';
import { formatDate } from '../../utils/dateUtils';
import { generateDocumentPDF, generateDocumentPDFBlob } from '../../utils/pdfGenerator';
